...
class TestCard(unittest.TestCase):
    ...
    def test_q5(self):
        ...
        '''
        deck = hw5_cards.Deck()
        deck_card_removed = deck.deal_card()
        self.assertIsInstance(deck_card_removed, hw5_cards.Card)
        return deck_card_removed, hw5_cards.Card
    ...
    def test_q7(self):
        ...
        deck = hw5_cards.Deck()
        deck_card_removed = deck.deal_card()
        replaced_card = deck.replace_card(deck_card_removed)
        self.assertEqual(len(deck.cards), 52, 52)
        return len(deck.cards),52, 52
    
    def test_q8(self):
        '''
        1. fill in your test method for question 8:
        Test that if
         you invoke the replace_card method 
         with a card that is already in the deck, 
         the deck size is not affected.
         (The function must silently 
        ...
        '''
        deck = hw5_cards.Deck()
        replaced_card = deck.replace_card(deck.cards[0])
        self.assertEqual(len(deck.cards), len(deck.cards))
        return len(deck.cards), len(deck.cards)
